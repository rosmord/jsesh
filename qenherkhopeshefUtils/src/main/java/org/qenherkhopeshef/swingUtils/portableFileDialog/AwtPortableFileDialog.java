...
public class AwtPortableFileDialog extends PortableFileDialog {
    ...
    public File getSelectedFile() {
        ...
        // return new File(delegate.getFile());
    }
     ...
     *
     * @param filters : list of filters. Ignored, as not usable with AWT.
     * @param fallbackFilter : the filter used.
     */
    @Override
    ...
    public void setSelectedFile(File file) {
        if (file != null) {
            delegate.setDirectory(file.getParent());
            delegate.setFile(file.getName());
        } else {
