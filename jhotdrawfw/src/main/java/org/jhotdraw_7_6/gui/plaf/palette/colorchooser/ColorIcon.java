...
public class ColorIcon implements javax.swing.Icon {
    ...
    public ColorIcon( Color color) {
        this(color, (color==null)?  ResourceBundleUtil.getBundle("org.jhotdraw_7_6.gui.Labels").getToolTipTextProperty("ColorChooser.colorSwatch.noColor") :color.getRed() + "," + color.getGreen() + "," + color.getBlue(), 14, 14);
    }
