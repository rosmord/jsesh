 ...
 * <p>
 * We now use IText for pdf export, so the freehep library 
 * wasn't very useful anymore.
 * We have decided to write this class to allow
 * the wmf export to be stand alone.
 *  We took some of the principles from freehep.
 * 
 * <p>
...
public abstract class BaseGraphics2D extends Graphics2D {
     ...
     * <p>To be used when writting copy constructor for subclasses. 
     * @param g
     */
     ...
     * Keep different states informations however.
     * Suggested implementation:
     * create a copy constructor and use
     * <pre>
    ...
    /**
     * Draws a shape.
     * <p>A basic, probably very suboptimal implementation of draw, which calls fill(shape).
     * For the sake of efficiency, you should probably rewrite it.
    ...
    public void drawString(AttributedCharacterIterator iterator, float x,
            float y) {
        GlyphVector vect= getFont().createGlyphVector(getFontRenderContext(),iterator);
    ...
    public void drawString(String s, float x, float y) {
        GlyphVector vect= getFont().createGlyphVector(getFontRenderContext(),s);
        drawGlyphVector(vect,x,y);
    }
    ...
    /*
     * Switches back to paint mode, disabling Xor mode.
     * <p>
     ...
     * <p> All scaling and assorted transformations in BaseGraphics2D use this method.
     * Hence, if you want to modify the transformation system, simply redefine it.
    ...
    /**
     * Communicates properties (which can be used as a generic system for parameters) to the graphic system.
     * @param properties
     */
...
//    /**
//     * Open a new page.
//     * Redefine this method if your system handles multipage documents.
//     * @param dimensions
//     * @param title
//     */
...
//    
//    /**
//     * Redefine this method if your system can do multi page documents.
//     * @return true if the system can handle multi paged documents.
//     */
