...
/**
 * A glyph ; basically a shape which can be painted). 
 * moved out of the Bzr package, as it's no longer even mainly used.
 * 
 ...
 * 
 * 
 *         TODO: Include documentation about the signs (author, license, etc.)
 *         TODO: get sure "fixShape" is always called when necessary (make it
 *         private?). The problem is that fixShape should only be called *after*
 *         setting both shape and ligature zones.
 */
...
public class ShapeChar implements Cloneable {
	 ...
	 * @param yscale
	 * @param angle
	 *            rotation angle for this glyph, in radians.
	 */
	 ...
	 * 
	 * <p>
	 * About the jseshg namespace (http://jsesh.qenherkhopeshef.org/jseshg/1.0)
	 * This namespace is currently used for informations which are not plain
	 * SVG. This includes author and the like.
	 * 
	 * @param out
	 * @param encoding
	 *            the name of the encoding to use. We suggest "UTF-8".
	 */
	 ...
	 * 
	 * @param i
	 *            ordinal number of the area. Currently : 0 or 1 ("before" or
	 *            "after").
