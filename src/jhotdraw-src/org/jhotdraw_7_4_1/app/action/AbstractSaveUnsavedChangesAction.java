 ...
 * to save unsaved changes of a {@link org.jhotdraw_7_4_1.app.View} before the
...
public abstract class AbstractSaveUnsavedChangesAction extends AbstractViewAction {
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (p.isEnabled()) {
            final ResourceBundleUtil labels = ResourceBundleUtil.getBundle("org.jhotdraw_7_4_1.app.Labels");
