...
public class CorpusSearchDialogFrame extends JFrame {
    ...
    public CorpusSearchDialogFrame(CorpusSearchTarget corpusSearchTarget, SearchUIResources searchUIResources) {
        this.jseshFolderPanel = SearchPanelFactory.createSearchFolderPanel(corpusSearchTarget, searchUIResources);
