    ...
    protected void initPalettes(final LinkedList<Action> paletteActions) {
        SwingUtilities.invokeLater(new Worker<LinkedList<JFrame>>() {
            ...
            public LinkedList<JFrame> construct() {
                ...
                LinkedList<JToolBar> toolBars = new LinkedList<JToolBar>(getModel().createToolBars(QenherOSXApplication.this, null));
                ...
                for (JToolBar tb : toolBars) {
                   ...
                   // d.setFocusableWindowState(false);
                    ...
                    paletteActions.add(new QenherTogglePaletteAction(QenherOSXApplication.this, d, tb.getName()));
                    palettes.add(d);
