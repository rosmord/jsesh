...
public class JSeshMenuBuilder extends DefaultMenuBuilder {
        ...
        public void addOtherMenus(List<JMenu> menus, Application app, View v) {
                if (v != null) {
                        menus.add(createInsertMenu(app, (JSeshView) v));
                        menus.add(createTextMenu(app, (JSeshView) v));
                        menus.add(createSignMenu(app, (JSeshView) v));
                }
        }

        private JMenu createInsertMenu(Application app, JSeshView view) {
                JMenu insertMenu = new JMenu();
                ActionMap map = app.getActionMap(view);

                BundleHelper.getInstance().configure(insertMenu, "insert");
                insertMenu.addSeparator();
                addToMenu(insertMenu, app, view, ActionsID.INSERT_SPACE);
                addToMenu(insertMenu, app, view, ActionsID.INSERT_HALF_SPACE);
                addToMenu(insertMenu, app, view, ActionsID.NEW_PAGE);
                addToMenu(insertMenu, app, view, ActionsID.INSERT_RED_POINT);
                addToMenu(insertMenu, app, view, ActionsID.INSERT_BLACK_POINT);
                insertMenu.addSeparator();
                ...
                //insertMenu.add(shadingSymbolsMenu);
                insertMenu.addSeparator();

                insertMenu.add(map.get(InsertNextLineNumberAction.ID));
                insertMenu.add(map.get(InsertShortTextAction.ID));
                return insertMenu;
        }
