...
public record SignDrawingSpecifications(
	...
	public static class Builder {
		...
		public Builder(SignDrawingSpecifications specs) {
		...
		public SignDrawingSpecifications build() {
			return new SignDrawingSpecifications(largeSignSizeRatio, smallSignSizeRatio, smallBodyScaleLimit);
		}
	}
