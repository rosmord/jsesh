...
//    
     ...
     *
     * @param key an MdC transliteration used as key (no space allowed, as it
    ...
    /**
     * Returns the entry in position "pos" in the list of entries. <p>Note that
     * the position is not a reliable identifier for an entry (as new entries
