 ...
 *
 * @author <a href="mailto:rosmord@djedefhor.iut.univ-paris8.fr">Serge
 *         ROSMORDUC</a>
 * @version 1.0
 */
public class MDCCartouche implements MDCSymbols {
     ...
     *             create. possible values are 'c', 's', 'f', 'h' and g. Uppercase
     *             letters are allowed.
     * @param part part of the cartouche to draw (0, 1 or 2). Meaning depends on the kind of cartouche.
     */
