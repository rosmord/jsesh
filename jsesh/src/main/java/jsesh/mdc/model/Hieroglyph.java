...
public class Hieroglyph extends InnerGroup implements HieroglyphInterface
{
	 ...
	 * Basically, there are :
	 * 	boolean modifiers, which work as a trigger
	 *  integer modifiers, which set an integer value.
	 * 	
	 * available operations are :
	 * 
	 * adding a new modifier.
	 * removing a modifier
	 * getting the collection of modifiers for easy inspection ? (it should return an iterator !)
	 * 
	 * For ease of use :
