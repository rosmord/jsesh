 ...
 *                                    ▲
 *                                    │ DirectoryReference (plain, observable)
 *                                    │
 ...
 *     {@link jsesh.utils.io.DirectoryReference} for user fonts, so it stays pure and
 ...
 *     {@code DirectoryReference} feeding the builder. It is also the write side:
 ...
 *     reference each other — they rendezvous at the {@code DirectoryReference}.
 ...
 * {@link jsesh.defaults.HieroglyphResourcesBuilder#buildFull(jsesh.utils.io.DirectoryReference, jsesh.glossary.Glossary)} directly with a bare
 * with a bare {@link jsesh.utils.io.DirectoryReference} and a bare {@link jsesh.glossary.Glossary}.
 */
