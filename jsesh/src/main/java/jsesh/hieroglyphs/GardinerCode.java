...
/**
 * Representation of a code in "gardiner form" in our fonts.
 * Usable for sorting and the like.
 * <p> The class also contains a number of helper functions which work on strings.
 * @author rosmord
 */
...
public class GardinerCode implements Comparable<GardinerCode> {
	...
	/**
	 * special unique translitteration codes, not linked with a specific Gardiner code.
	 */
	...
	/**
	 * Pattern for testing for codes which are "Gardiner-like", i.e. with a family part in them.
	 */
	...
	/**
	 * Create a Gardiner code object from a string.
	 * Send a triplet (family, number, variant) or null if the code hasn't got
	 * the proper form.
	 * 
	 * @param code
	...
	/**
	 * Returns the id of the user who created this sign, or 0 for standard signs.
	 * @return
	 */
	...
	/**
	 * Return the names of the "Gardiner" families, in the usual order.
	 * Includes the additionnal Ff family.
	...
	/**
	 * Returns a comparator able to compare two gardiner codes (as strings) and to order
	 * them.
	 * 
	 ...
	 * <p> We define canonical MdC codes as:
	 * <ul>
	 * <li> Gardiner codes (see isCorrectGardinerCode)
	 * <li> Codes documented in the manuel de codage for the few signs wich haven't got a Gardiner code.
	 *  <ul>
	 *  	<li> "nn" or "nTrw"
	 *  	<li> numbers 2,4,5,6,7,8,9, 20, ..., 90, 200..900, 2000..9000 etc...</li>
	 *		<li> tksesh user sign code of the form UG<em>n0</em>M<em>n1</em>N<em>n2</em>
	 * 			where 
	 * 			<ul>
	 ...
	 *  </ul>
	 * </ul>
	 * Note that translitteration codes (except nTrw and nn) are not dealt with here. 
	 * @param code
	 * @return
