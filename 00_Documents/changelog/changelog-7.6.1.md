...
It mainly fixes a few problems - it also distributes new content.
...
You might have noticed that I'm a bit conservative as far as sign list extension go. Most of those signs are perfectly legitimate, but I'd rather take some time before adding them. The signs are included in the text library, in a separate folder. You can set this folder `texts/KV34/Complements-KV34` as Hieroglyphic folder in JSesh preferences to display them.
