# Architectura Decision Records (ADR) for jsesh development

This folder contains *Architectural Decision Records* (ADR) for jsesh development (mostly from may 2026 onwards).
...
Title
: a short title for the decision. Contains the ID of the decision and a short description.
...
- deprecated: the decision is deprecated, and should not be used anymore.
- superseded: the decision is superseded by another decision, which is mentioned in the "Superseding ADR" section.
...
Consequences
: the consequences of the decision, including the benefits and the drawbacks of it.
