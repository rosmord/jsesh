/**************************************************************
  ...
  1/9/06 [S. Rosmorduc for JSesh] : small change. Made everything which used 
    unpackFromString static, in order to improve performances.
  ...
  Version 1.1.1, September 3, 1996 [Andrew Appel]
    Made the class "JSeshMain" instead of "JavaLex", 
	...
	for (istate = 0; nstates > istate; ++istate)
	  {
	    ...
	    */
	    ...
	    /* JSeshMain loop of CDTrans creation. */
